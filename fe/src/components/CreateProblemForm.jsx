        ...
        <div className="card-body p-6 md:p-8">
          <div className="mb-6 flex flex-col items-start justify-between border-b pb-4 md:mb-8 md:flex-row md:items-center">
            <h2 className="card-title flex items-center gap-3 text-2xl md:text-3xl">
              <FileText className="text-primary h-6 w-6 md:h-8 md:w-8" />
              Create Problem
            </h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="form-control md:col-span-2">
                <label className="label">
                  <span className="label-text text-base font-semibold md:text-lg">Title</span>
                </label>
                <input
                  type="text"
              ...
              <div className="form-control md:col-span-2">
                <label className="label">
                  <span className="label-text text-base font-semibold md:text-lg">Description</span>
                </label>
                <textarea
                  className="textarea textarea-bordered min-h-32 w-full resize-y p-4 text-base md:text-lg"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-base font-semibold md:text-lg">Difficulty</span>
                </label>
                <select
            ...
            {/* Tags */}
            <div className="card bg-base-200 p-4 shadow-md md:p-6">
                    ...
                    <div className="card-body p-4 md:p-6">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
                        <div className="form-control">
                          ...
                          <textarea
                            className="textarea textarea-bordered min-h-24 w-full resize-y p-3"
            ...
            <div className="space-y-8">
              {['JAVASCRIPT', 'PYTHON', 'JAVA'].map(language => (
                <div key={language} className="card bg-base-200 p-4 shadow-md md:p-6">
                  <h3 className="mb-6 flex items-center gap-2 text-lg font-semibold md:text-xl">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="card bg-base-100 shadow-md">
                      <div className="card-body p-4 md:p-6">
                        <h4 className="mb-4 flex items-center gap-2 text-base font-semibold md:text-lg">
                    ...
                    <div className="card bg-base-100 shadow-md">
                      <div className="card-body p-4 md:p-6">
                        <h4 className="mb-4 text-base font-semibold md:text-lg">Example</h4>
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
                          <div className="form-control">
                            <label className="label">
                              <span className="label-text font-medium">Input</span>
                            ...
                            <textarea
                              className="textarea textarea-bordered min-h-20 w-full resize-y p-3"
            ...
            <div className="card bg-base-200 p-4 shadow-md md:p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="form-control">
                  ...
                  <textarea
                    className="textarea textarea-bordered min-h-32 w-full resize-y p-3"
                    {...register('editorial')}
